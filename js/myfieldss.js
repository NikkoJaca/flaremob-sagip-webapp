function enableFields(cb,quantity,desc, evac)
{
    if(cb.checked)
    {
        document.getElementById(quantity).disabled = false;
        document.getElementById(desc).disabled = false;
        document.getElementById(evac).disabled = false;
        
    }else{
        document.getElementById(quantity).disabled = true;
        document.getElementById(desc).disabled = true;
        document.getElementById(evac).disabled = true;        
    }

}

function enableField(cb,quantity,unit,desc, evac)
{
    if(cb.checked)
    {
        document.getElementById(quantity).disabled = false;
